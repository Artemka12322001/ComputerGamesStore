...
public class Controller {
    ...
    private static final String PATH_TO_LAYOUT = "/cgs/layout/";
    ...
    public static void setShowStage(FXMLLoader loader) {
        stage.setTitle("Магазин компьютерных игр");
        stage.getIcons().add(new Image("file:src\\main\\resources\\cgs\\image\\logo.png"));
